  ...
  <nav class="navbar" role="navigation" aria-label="main navigation">
    ...
    <div class="nav-icons">
      ...
      <img
        ...
        id="burger"
        v-bind:src="this.isOpen ? xIcon : burgerMenuIcon"
        v-on:click="toogle"
      />
      ...
      <div
        :class="{
          ...
          'open-desktop': this.isOpen && width >= 760,
          'close-desktop': !this.isOpen && width >= 760,
...
import baseIconUser from "@/assets/icons/user-circle-solid-36.png";
...
export default {
  ...
  data() {
    return {
      logo: baseLogo,
      userIcon: this.$store.state.token ? baseIconUserLogged : baseIconUser,
  ...
  methods: {
    ...
    hideElementOnLoad: function () {
      ...
      if (this.isOpen === false && this.width > 760) {
        const addClassHideDesktop = document.querySelector(".close-desktop");
